...
class AlphaScoreDisplay(game.ScoreDisplay):
    ...
    def reset(self):
            ...
            self.ball_text_data=[]
            self.match_text_data=[]
            self.top_text_data=[]
            self.bottom_text_data=[]
            for i in range(2):
                self.ball_text_data.append(' ')
                self.match_text_data.append(' ')
            for i in range(16):
    ...
    def test(self):
        self.set_text('grand  lizard'.upper(),0)
    ...
    def update_layer_1p(self, font=None):
        ...
        if self.game.current_player() == None:
            ...
            if score>999999:
                posn = self.player_score_posn[0]+2
            elif score>999:
    ...
    def update_layer_4p(self):
        ...
        for i in range(len(self.game.players[:4])): # Limit to first 4 players for now.
            ...
            if score>999999:
                posn = self.player_score_posn[i]+2
            elif score>999:
    ...
    def set_ballmatch(self,ball,match):
        self.ball_text_data=ball
        self.match_text_data=match
        self.copy_ballmatch()
        self.update_alpha_display()
    
    def copy_ballmatch(self):
        self.top_text_data[0]=self.match_text_data[0]
        self.top_text_data[8]=self.match_text_data[1]
        self.bottom_text_data[0]=self.ball_text_data[0]
        self.bottom_text_data[8]=self.ball_text_data[1]
    ...
    def set_text(self,text,row,justify='center',opaque=True,blink_rate=0,seconds=0):
        ...
        if row==0:
            ...
            for i in range(len(text)):
                ...
                self.bottom_text_data[i+posn]=text[i]
        self.copy_ballmatch()
        self.update_alpha_display()
